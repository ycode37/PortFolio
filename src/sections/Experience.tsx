      ...
      content: (
        <div>
          <h1 className="text-3xl md:text-5xl mb-6  font-serif">
            GulaabJamoon Experiences
          </h1>
          <p className=" text-xs md:text-[14px] font-normal mb-8 font-poppins leading-relaxed">
            At GulaabJamoon Experiences, I played a key role as a fullstack
            developer in the development of gulaabjamoon.com, an expericence
            tour booking Platform, ensuring a seamless and interactive
            experience. Additionally, I designed and built websites for CraftX,
            Bengalauru, India. and The Mojo Effect, implementing Framer Motion
            and GSAP to enhance visual storytelling and engagement.
          </p>
      ...
      content: (
        <div>
          ...
          <p className=" text-xs md:text-sm font-normal mb-8">
            As the Frontend Lead I started Working for my Own , I was
            responsible for designing and developing projects for Clients , I
            participated In Hackathon . The project won Second place in a
            competition spanning all of Vadodara, showcasing innovation in
